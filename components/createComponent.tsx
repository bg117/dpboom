...
export default function CreateComponent() {
    ...
    const changeEventCaption = useCallback(
        (event: ChangeEvent<HTMLTextAreaElement>) =>
            setEventCaption(event.target.value),
        []
    );
    const changeEventFramePath = useCallback(
        (event: ChangeEvent<HTMLInputElement>) => {
            ...
            if (file) {
                ...
                reader.onload = e =>
                    setEventFrame((e.target?.result as string) ?? '');
    ...
    const changeEventIsPublic = useCallback(
        (event: ChangeEvent<HTMLInputElement>) =>
            setEventIsPublic(event.target.checked),
        []
    );
    const changeEventSlug = useCallback(
        (event: ChangeEvent<HTMLInputElement>) =>
